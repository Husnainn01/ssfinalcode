...
export default function InvoiceDocumentsPage() {
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      setIsLoading(true)
      try {
        const response = await fetch('/api/admin/vehicles/documents?type=invoice')
        if (!response.ok) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold">Invoice Documents</h1>
        </div>
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Upload an invoice for a customer vehicle
              </DialogDescription>
            </DialogHeader>
      ...
      {error && (
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded flex items-center">
          ...
          <span>Error loading invoice documents: {error}</span>
        </div>
      )}
      ...
      {isLoading ? (
        <div className="flex justify-center items-center py-8">
          ...
          <span className="ml-2">Loading invoice documents...</span>
        </div>
      ) : (
        <Card>
