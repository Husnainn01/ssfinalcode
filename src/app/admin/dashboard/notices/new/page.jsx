...
export default function AddNoticePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    isActive: true,
    showOnPages: ['all'],
    expiresAt: new Date(+new Date() + 30*24*60*60*1000).toISOString().split('T')[0], // 30 days from now
    position: 'top'
  });
    ...
    <AdminMenu>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Create a new notice or announcement for your website</p>
        </div>
